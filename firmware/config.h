...
extern unsigned char STEPPER_SPEED;   // define speed of the motor
...
*/
//typedef struct ioRow inputRow;    // describes one row of input / output pins
//typedef struct ioRow outputRow;   // describes one row of input / output pins
